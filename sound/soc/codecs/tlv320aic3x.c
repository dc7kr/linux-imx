...
static int aic3x_init(struct snd_soc_codec *codec)
{
	...
	case AIC3X_MODEL_3007:
		...
		break;
/* L4B begin (Martin Stecklum) */
	case AIC3X_MODEL_3104:
		/* Mute Line1 and route  Mic2 to ADC PGA mixer */
		snd_soc_write(codec, LINE1L_2_LADC_CTRL, 0x78);
		snd_soc_write(codec, LINE1R_2_RADC_CTRL, 0x78);
		snd_soc_write(codec, MIC3LR_2_LADC_CTRL, 0x0f);
		snd_soc_write(codec, MIC3LR_2_RADC_CTRL, 0xf0);
		break;
/* L4B end */
	}
